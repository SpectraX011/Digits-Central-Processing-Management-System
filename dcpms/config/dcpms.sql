...
('2400703', 'ydFKRMU0kDNqXDhOxOViWulLx9efh.BgcWCOV7JFAgTsQXWhs8oqC', 'John Alberto Digit_PIO ', 'johnalberto@digits.com', 'digit_officer'),
('2400704', 'y.4kKlHAVcZ/5o.qF4LugKJUt.jm.jCtUQzA8l6cPu1BhO', 'Daniel Prudenciado', 'danielprudenciado@student.com', 'student');
...
SET email = 'maria.santos@digits.com',
    role = 'digit_officer'
WHERE studentID = '2400706';-- phpMyAdmin SQL Dump
-- version 5.2.1
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1:3306
